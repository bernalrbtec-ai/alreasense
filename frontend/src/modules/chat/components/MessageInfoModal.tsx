...
export function MessageInfoModal({ message, onClose }: MessageInfoModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50" onClick={onClose} role="dialog" aria-modal="true" aria-labelledby="message-info-modal-title">
      <div
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-600">
          <h2 id="message-info-modal-title" className="text-lg font-semibold text-gray-900 dark:text-gray-100">Informações da Mensagem</h2>
          <button
            onClick={onClose}
