          ...
          <div className="mt-4 space-y-4 animate-fade-in">
            <div>
              ...
              <input
                ...
                className="block w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-lg py-2 px-4"
                required
              />
            ...
            <div className="pt-2 border-t border-gray-200 dark:border-gray-600">
              <Button
                ...
                disabled={isSending}
                variant="outline"
                className="w-full sm:w-auto border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700"
              >
                {isSending ? (
                  <>
