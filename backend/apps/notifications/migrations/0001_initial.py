        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "health_score",
                    models.IntegerField(
                        default=100, help_text="Score de saúde da instância (0-100)"
                    ),
                ),
                (
                    "msgs_sent_today",
                    models.IntegerField(default=0, help_text="Mensagens enviadas hoje"),
                ),
                (
                    "msgs_delivered_today",
                    models.IntegerField(
                        default=0, help_text="Mensagens entregues hoje"
                    ),
                ),
                (
                    "msgs_read_today",
                    models.IntegerField(default=0, help_text="Mensagens lidas hoje"),
                ),
                (
                    "msgs_failed_today",
                    models.IntegerField(default=0, help_text="Mensagens com erro hoje"),
                ),
                (
                    "consecutive_errors",
                    models.IntegerField(default=0, help_text="Erros consecutivos"),
                ),
                (
                    "last_success_at",
                    models.DateTimeField(
                ...
                (
                    "last_health_update",
                    models.DateTimeField(
                        auto_now=True, help_text="Última atualização do health score"
                    ),
                ),
                (
                    "health_last_reset",
