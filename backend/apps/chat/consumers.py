...
class ChatConsumer(AsyncWebsocketConsumer):
    ...
    async def attachment_downloaded(self, event):
        """
        Broadcast quando anexo termina de baixar.
        ...
        logger.info(f"📡 [CHAT WS] Notificação de anexo baixado enviada")
    ...
    def serialize_message(self, message):
        """Serializa mensagem para JSON, convertendo UUIDs para strings."""
