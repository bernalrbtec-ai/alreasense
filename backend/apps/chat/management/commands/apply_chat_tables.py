"""
Management command para criar as tabelas do Chat diretamente no banco
"""
from django.core.management.base import BaseCommand
from django.db import connection

class Command(BaseCommand):
    help = 'Aplica as tabelas do Chat diretamente no banco de dados'

    def handle(self, *args, **options):
        self.stdout.write("🚀 Aplicando tabelas do Flow Chat...")
        self.stdout.write("=" * 60)
        
        sql = """
        -- Dropar tabelas existentes (se houver versão antiga)
        ...
        try:
            ...
            self.stdout.write(self.style.SUCCESS("\n🎉 Flow Chat instalado com sucesso!"))
